...
import Video from '../../../videos/marca.mp4'
...
const MarcaBase = () => {
    ...
    return (
        ...
        <div className="py-8 rounded-3xl max-w-full text-gray-700 bg-white shadow">
            <h2 className="text-3xl text-center font-medium mb-10 pl-3 md:pl-6">¡Seccion de Marcas!</h2>
            <section className="px-3 md:px-8 my-16">
                ...
                <div className="w-full flex justify-center items-center">
                    ...
                    <a href="/admin/marcas/agregar">Agregar Marca</a>
                    </button>
                    <button className="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded-r">
                    <a href="/admin/marcas/all">Mostrar todas las Marcas</a>
                    </button>
                </div>        
            </section>
        </div>
